...
class NyzoMessage {
  ...
  Uint8List getBytes(bool includeSignature) {
    ...
    print('message byte buffer is ' + hexStringFromArrayWithDashes(byteArray, 0, byteArray.length));
  ...
  KeyPair keyPair = Signature.keyPair_fromSeed(hexStringAsUint8Array(privKey)); //Creates a KeyPair from the generated Seed
...
"Accept": "*/*",
"Referer": "https://nyzo.co/wallet?id="+HEX.encode(pubKey),//change this to + pubKey
"Accept-Encoding": "gzip, deflate, br",
"Accept-Language": "en-GB,en;q=0.9,fr-FR;q=0.8,fr;q=0.7,es-MX;q=0.6,es;q=0.5,de-DE;q=0.4,de;q=0.3,en-US;q=0.2",
        },
   ...
   contentForType(messageType, Uint8List byteArray, index) {
    print('getting content for type ' + messageType.toString() + ' from index ' + index.toString());
